...
public class MakeMoveTests {
    ...
    public void promotionMoves(ChessPiece.PieceType promotionType) throws InvalidMoveException {
        ...
        Assertions.assertNull(game.getBoard().getPiece(whitePromotion.getStart()),
                "After move, a piece is still present in the start position");
        ChessPiece whiteEndPiece = game.getBoard().getPiece(whitePromotion.getEnd());
        ...
        Assertions.assertNull(game.getBoard().getPiece(blackPromotion.getStart()),
                "After move, a piece is still present in the start position");
        ChessPiece blackEndPiece = game.getBoard().getPiece(blackPromotion.getEnd());
